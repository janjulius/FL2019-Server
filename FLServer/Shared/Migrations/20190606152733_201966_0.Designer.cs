...
namespace Shared.Migrations
{
    ...
    [Migration("20190606152733_201966_0")]
    partial class _201966_0
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FLServer.Models.FriendRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Shared.Models.Message", b =>
                {
                    b.HasOne("FLServer.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("FLServer.Models.User", "Sender")
                        .WithMany()
